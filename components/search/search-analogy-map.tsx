...
import { SEARCH_ANALOGY } from "@/lib/search";
import { getIcon } from "@/lib/icons";
import { cn } from "@/lib/utils";

/**
 * Section 1 — maps each restaurant-directory step to its search equivalent.
 * Hover glows the card and brings its explanation into focus.
 */
export function SearchAnalogyMap() {
  const [hovered, setHovered] = useState<string | null>(null);

  return (
    <div className="grid gap-4 sm:grid-cols-2">
      {SEARCH_ANALOGY.map((pair, i) => {
        ...
        return (
          <motion.div
            ...
            className={cn(
              ...
              i === SEARCH_ANALOGY.length - 1 && "sm:col-span-2"
            )}
          >
