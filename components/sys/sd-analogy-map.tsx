...
import { SD_ANALOGY } from "@/lib/system-design";
import { getIcon } from "@/lib/icons";
import { cn } from "@/lib/utils";

/**
 * Section 1 — maps each restaurant-chain role to its software equivalent.
 * Hover glows the card and brings its explanation into focus.
 */
export function SdAnalogyMap() {
  const [hovered, setHovered] = useState<string | null>(null);

  return (
    <div className="grid gap-4 sm:grid-cols-2">
      {SD_ANALOGY.map((pair, i) => {
        ...
        return (
          <motion.div
            ...
            className={cn(
              ...
              i === SD_ANALOGY.length - 1 && "sm:col-span-2"
            )}
          >
