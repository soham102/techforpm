...
import { REC_ANALOGY } from "@/lib/recommendations";
import { getIcon } from "@/lib/icons";
import { cn } from "@/lib/utils";

/**
 * Section 1 — maps each smart-store-assistant step to its app equivalent.
 * Hover glows the card and brings its explanation into focus.
 */
export function RecAnalogyMap() {
  const [hovered, setHovered] = useState<string | null>(null);

  return (
    <div className="grid gap-4 sm:grid-cols-2">
      {REC_ANALOGY.map((pair, i) => {
