...
import { QUEUE_ANALOGY } from "@/lib/queues";
import { getIcon } from "@/lib/icons";
import { cn } from "@/lib/utils";

/**
 * Section 1 — maps each restaurant order-counter step to its app
 * equivalent. Hover glows the card and brings its explanation forward.
 */
export function QueueAnalogyMap() {
  const [hovered, setHovered] = useState<string | null>(null);

  return (
    <div className="grid gap-4 sm:grid-cols-2">
      {QUEUE_ANALOGY.map((pair, i) => {
